...
func main() {
	...
	if *help {
		os.Stderr.WriteString(`mocktlsserver

about:
A mock TLS server for testing purposes. Run it without arguments to start
listening with an autogenerated private key and certificate chain.

See https://pkg.go.dev/crypto/tls#LoadX509KeyPair for handling of certificate
chain file.
